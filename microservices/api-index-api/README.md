...
The **API Index API** is a core backend component of the **Snow White** system.
...
| --------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- |
| `SNOW_WHITE_API_INDEX_PUBLIC_API_GATEWAY_URL` | Public URL of the [`api-gateway`](../api-gateway). Used to construct external links and route information. | `http://localhost`                                       |
