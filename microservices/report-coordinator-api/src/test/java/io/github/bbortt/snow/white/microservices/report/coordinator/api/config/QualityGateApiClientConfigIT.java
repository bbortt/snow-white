...
class QualityGateApiClientConfigIT extends AbstractReportCoordinationServiceIT {
  ...
  class ApiIndexApiTest {
    ...
    @Test
    void isBean() {
      assertThat(applicationContext.getBean(QualityGateApi.class)).isInstanceOf(
        QualityGateApi.class
      );
    }
  }
}
