...
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- |
| `SNOW_WHITE_REPORT_COORDINATOR_API_API-INDEX_BASE-URL`                 | Internal URL to the `api-index-api` for specification information requests.                                | `http://api-index-api:8080`                              |
...
| `SNOW_WHITE_REPORT_COORDINATOR_API_QUALITY-GATE-API_BASE-URL`          | Internal URL to the `quality-gate-api` for data collection.                                                | `http://quality-gate-api:8080`                           |
