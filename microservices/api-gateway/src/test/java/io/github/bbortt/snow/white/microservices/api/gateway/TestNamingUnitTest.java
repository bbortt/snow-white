...
class TestNamingUnitTest {
  ...
  @ArchTest
  static final ArchRule testClassesShouldFollowNamingConvention = testClassesShouldFollowNamingConvention();

  @ArchTest
  static final ArchRule nestedTestClassesShouldEndInTest = nestedTestClassesShouldEndInTest();
}
