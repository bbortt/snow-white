package io.github.bbortt.snow.white.kafka.event.filter.processor.json;

import static io.github.bbortt.snow.white.kafka.event.filter.config.KafkaEventFilterProperties.CONSUMER_MODE_PROPERTY_NAME;

import io.github.bbortt.snow.white.kafka.event.filter.config.KafkaEventFilterProperties;
import io.github.bbortt.snow.white.kafka.event.filter.processor.AbstractExportTraceServiceRequestEventProtobufProcessor;
