...
import static io.github.bbortt.snow.white.kafka.event.filter.processor.TestData.API_NAME;
import static io.github.bbortt.snow.white.kafka.event.filter.processor.TestData.API_NAME_PROPERTY;
import static io.github.bbortt.snow.white.kafka.event.filter.processor.TestData.API_VERSION;
import static io.github.bbortt.snow.white.kafka.event.filter.processor.TestData.API_VERSION_PROPERTY;
import static io.github.bbortt.snow.white.kafka.event.filter.processor.TestData.OTEL_SERVICE_NAME;
import static io.github.bbortt.snow.white.kafka.event.filter.processor.TestData.OTEL_SERVICE_NAME_PROPERTY;
import static io.github.bbortt.snow.white.kafka.event.filter.processor.TestData.RESOURCE_SPANS_WITHOUT_API_NAME;
import static io.github.bbortt.snow.white.kafka.event.filter.processor.TestData.RESOURCE_SPANS_WITHOUT_API_VERSION;
import static io.github.bbortt.snow.white.kafka.event.filter.processor.TestData.RESOURCE_SPANS_WITHOUT_OTEL_SERVICE_NAME;
import static io.github.bbortt.snow.white.kafka.event.filter.processor.TestData.RESOURCE_SPANS_WITH_ATTRIBUTES_ON_EACH_LEVEL;
...
class ExportTraceServiceRequestFilterUnitTest {
