package io.github.bbortt.snow.white.microservices.kafka.event.filter.processor;

import static io.github.bbortt.snow.white.microservices.kafka.event.filter.processor.TestData.API_NAME;
import static io.github.bbortt.snow.white.microservices.kafka.event.filter.processor.TestData.API_NAME_PROPERTY;
import static io.github.bbortt.snow.white.microservices.kafka.event.filter.processor.TestData.API_VERSION;
import static io.github.bbortt.snow.white.microservices.kafka.event.filter.processor.TestData.API_VERSION_PROPERTY;
import static io.github.bbortt.snow.white.microservices.kafka.event.filter.processor.TestData.OTEL_SERVICE_NAME;
import static io.github.bbortt.snow.white.microservices.kafka.event.filter.processor.TestData.RESOURCE_SPANS_WITHOUT_API_NAME;
import static io.github.bbortt.snow.white.microservices.kafka.event.filter.processor.TestData.RESOURCE_SPANS_WITHOUT_API_VERSION;
import static io.github.bbortt.snow.white.microservices.kafka.event.filter.processor.TestData.RESOURCE_SPANS_WITHOUT_OTEL_SERVICE_NAME;
import static io.github.bbortt.snow.white.microservices.kafka.event.filter.processor.TestData.RESOURCE_SPANS_WITH_ATTRIBUTES_ON_EACH_LEVEL;
import static io.github.bbortt.snow.white.microservices.kafka.event.filter.processor.TestData.RESOURCE_SPANS_WITH_RESOURCE_ATTRIBUTES;
import static io.github.bbortt.snow.white.microservices.kafka.event.filter.processor.TestData.RESOURCE_SPANS_WITH_SCOPE_ATTRIBUTES;
import static io.github.bbortt.snow.white.microservices.kafka.event.filter.processor.TestData.RESOURCE_SPANS_WITH_SPAN_ATTRIBUTES;
import static io.github.bbortt.snow.white.microservices.kafka.event.filter.processor.TestData.SERVICE_NAME_PROPERTY;
import static io.github.bbortt.snow.white.microservices.kafka.event.filter.processor.TestData.wrapResourceSpans;
