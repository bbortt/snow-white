...
public class ApiIndexCachingService implements CachingService {
  ...
  public @NonNull String fetchApiSourceUrl(ApiInformation apiInformation)
    ...
    try {
      ...
      // api-index-api responds 404 when the API isn't indexed, rather than 200 with an
      // empty body - RestClient throws for this instead of returning the response entity.
    }
