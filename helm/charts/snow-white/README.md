...
| otelCollector.exposeThroughApiGateway                      | bool   | `true`                                                                                                           | Whether to expose the OTeL collector through the (public) ingress.                                                                                                                                                        |
| otelCollector.image.registry                               | string | `"docker.io"`                                                                                                    | Image registry.                                                                                                                                                                                                           |
| otelCollector.image.tag                                    | string | `"0.157.0"`                                                                                                      | Image tag.                                                                                                                                                                                                                |
