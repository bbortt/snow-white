...
| otelCollector.connectoToExternalOtelCollector.endpoint     | string | `""`                                                                                                             | Configure this endpoint to expose Snow-White internal telemetry data to external OTeL collector for monitoring. |
| otelCollector.connectoToExternalOtelCollector.tls.insecure | bool   | `true`                                                                                                           | Whether the external OTeL collector connection may be insecure.                                                 |
...
| otelCollector.image.tag                                    | string | `"0.146.1"`                                                                                                      | Image tag.                                                                                                      |
