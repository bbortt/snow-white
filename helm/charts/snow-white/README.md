...
| Key                                                        | Type   | Default                                                                                                          | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ---------------------------------------------------------- | ------ | ---------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| influxdb2.adminUser.bucket                                 | string | `"snow-white"`                                                                                                   | InfluxDB bucket.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| influxdb2.adminUser.organization                           | string | `"snow-white"`                                                                                                   | InfluxDB organization.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| otelCollector.debug.sampling.initial                       | int    | `2`                                                                                                              | Number of messages initially logged each second. See: https://github.com/open-telemetry/opentelemetry-collector/blob/main/exporter/debugexporter/README.md#getting-started.                                                                                                                                                                                                                                                                                                                                                                                |
| otelCollector.debug.sampling.thereafter                    | int    | `10`                                                                                                             | Sampling rate after the initial messages are logged (every Mth message is logged each second). See: https://github.com/open-telemetry/opentelemetry-collector/blob/main/exporter/debugexporter/README.md#getting-started.                                                                                                                                                                                                                                                                                                                                  |
| otelCollector.disableIngestion                             | bool   | `false`                                                                                                          | Disable the bundled telemetry ingestion stack: the OTel Collector's coverage-trace pipelines, the `otel-event-filter-stream` Deployment, and the public `/v1/traces` route are not created. Self-observability (Snow-White's own microservice telemetry) is unaffected. Use this to route telemetry to an externally operated backend instead of the bundled one. Does NOT disable `influxdb2.enabled` automatically (Helm can't derive one subchart's enabled flag from another value) — set that separately, or the InfluxDB StatefulSet deploys unused. |
| otelCollector.exposeThroughApiGateway                      | bool   | `true`                                                                                                           | Whether to expose the OTeL collector through the (public) ingress. Ignored when `otelCollector.disableIngestion` is `true`.                                                                                                                                                                                                                                                                                                                                                                                                                                |
| otelCollector.image.registry                               | string | `"docker.io"`                                                                                                    | Image registry.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| otelCollector.image.tag                                    | string | `"0.160.0"`                                                                                                      | Image tag.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| kafka.image.tag                | string | `"8.3.1"`                                                                                                                  | Image tag.                                                         |
...
| snowWhite.openapiCoverageStream.tempo.endpoint           | string | `""`                                                                          | Grafana Tempo endpoint. Setting this switches the service to the Tempo backend and disables the InfluxDB wiring above. |
| snowWhite.openapiCoverageStream.tempo.orgId              | string | `""`                                                                          | Tenant sent as the `X-Scope-OrgID` header, for multi-tenant Tempo instances. Omitted when unset.                       |
| snowWhite.openapiCoverageStream.tempo.password           | string | `""`                                                                          | Password for Tempo HTTP Basic authentication. Requires `username`.                                                     |
| snowWhite.openapiCoverageStream.tempo.passwordFromSecret | object | `{"key":"","name":""}`                                                        | Password for Tempo HTTP Basic authentication - read from a Secret. Requires `username`.                                |
| snowWhite.openapiCoverageStream.tempo.token              | string | `""`                                                                          | Bearer token for Tempo authentication. Mutually exclusive with `username`/`password`.                                  |
| snowWhite.openapiCoverageStream.tempo.tokenFromSecret    | object | `{"key":"","name":""}`                                                        | Bearer token for Tempo authentication - read from a Secret. Mutually exclusive with `username`/`password`.             |
| snowWhite.openapiCoverageStream.tempo.username           | string | `""`                                                                          | Username for Tempo HTTP Basic authentication. Requires `password`.                                                     |
...
| snowWhite.openapiCoverageStream.influxdb                       | object | `{"endpoint":"","token":""}`               | Telemetry backend queried for coverage calculation. Exactly one of `influxdb` or `tempo` may be configured (mirrors the service's own startup validation). Set `tempo.endpoint` to switch to Grafana Tempo, which disables the InfluxDB wiring below entirely. |
