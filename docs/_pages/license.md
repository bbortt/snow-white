...
- **Use** Snow-White for any purpose within your organization
...
If your organization exceeds the thresholds above, or if you intend to redistribute Snow-White as part of a commercial product, you need a commercial license.
...
The complete license text is available in the [LICENSE file](https://github.com/bbortt/snow-white/blob/main/LICENSE) in the repository, and at [polyformproject.org/licenses/small-business/1.0.0](https://polyformproject.org/licenses/small-business/1.0.0).
