...
(Acceptance Criteria, Out of scope, Realizes, Related, and Status itself)
must stay a bold label, so it stays suppressed for the file.

Prose in every field — Business Value, Problem / Context, and the rest —
