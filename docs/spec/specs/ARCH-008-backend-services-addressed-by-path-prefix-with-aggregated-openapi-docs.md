...
[CON-006](CON-006-actuator-endpoints-deny-by-default.md) for which actuator paths are
reachable at all.
...
([CON-006](CON-006-actuator-endpoints-deny-by-default.md)) as the single source of truth
...
- [CON-006](CON-006-actuator-endpoints-deny-by-default.md) — the actuator surface this
