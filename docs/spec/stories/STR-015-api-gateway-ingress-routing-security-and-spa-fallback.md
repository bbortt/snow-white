...
Its most consequential behaviors are exactly the ones a caller or an operator cannot see from
...
black-box suites) found no code anchored to any spec in the corpus — this module's behavior is
...
gateway's own observable behavior — the SPA fallback rewrite and the downstream-failure error
mapping.
...
- [ARCH-008](../specs/ARCH-008-backend-services-addressed-by-path-prefix-with-aggregated-openapi-docs.md)
  — the routing and docs-aggregation scheme
- [ARCH-009](../specs/ARCH-009-static-assets-bypass-the-security-filter-chain.md) — static
  assets excluded from the filter chain entirely
- [CON-006](../specs/CON-006-actuator-endpoints-deny-by-default.md) — the actuator
  deny-by-default invariant
- [SW-024](../specs/SW-024-spa-fallback-rewrites-unmapped-routes-to-index-html.md) — the
  SPA fallback rewrite
- [SW-025](../specs/SW-025-gateway-error-mapping-distinguishes-downstream-unavailable.md)
...
- [STR-011](STR-011-analysis-coordination-and-report-lifecycle.md) — a sibling retrace with the
  same shape (undocumented existing behavior, no code changes)
